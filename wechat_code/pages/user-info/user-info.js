...
shoujihaoma: userInfo.shoujihaoma,
    ...
    userInfoObj["sfsh"]= userInfo.sfsh==null?"":userInfo.sfsh
    userInfoObj["shhf"]= userInfo.shhf==null?"":userInfo.shhf
    userInfoObj["fangdongzhanghao"]= userInfo.fangdongzhanghao==null?"":userInfo.fangdongzhanghao
    userInfoObj["fangdongmima"]= userInfo.fangdongmima==null?"":userInfo.fangdongmima
    userInfoObj["fangdongxingming"]= userInfo.fangdongxingming==null?"":userInfo.fangdongxingming
userInfo['touxiang']=userInfo?.touxiang?.replace('upload','file')
this.setData({
touxiang:baseURL+userInfo.touxiang,
tempPathtouxiang:baseURL+userInfo.touxiang,
...
lianxidianhua: userInfo.lianxidianhua,
    ...
    userInfoObj["shenfenzhenghao"]= userInfo.shenfenzhenghao==null?"":userInfo.shenfenzhenghao
    userInfoObj["sfsh"]= userInfo.sfsh==null?"":userInfo.sfsh
    userInfoObj["shhf"]= userInfo.shhf==null?"":userInfo.shhf
    this.setData(
        userInfoObj
...
fangdongmima:this.data.fangdongmima,
